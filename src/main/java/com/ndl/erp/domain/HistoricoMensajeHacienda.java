...
@Entity
@Table(name="historico_mensaje_hacienda")
public class HistoricoMensajeHacienda {
    @Id
    @GeneratedValue
    private Integer id;
    ...
    private String estadoHacienda = "ESPERA";
    ...
    public boolean equals(Object o) {
        ...
        HistoricoMensajeHacienda p = (HistoricoMensajeHacienda) o;
