...
public class ScheduleFixedCostDTO implements ScheduleGastos,Serializable {

    private static final long serialVersionUID = 1777000000000000057L;
    private Integer id;
    ...
    public ScheduleFixedCostDTO() {
    }

    public ScheduleFixedCostDTO(FixedCost i) {
        id = i.getId();
