...
@XmlType(name = "UbicacionTypeV43", namespace = "https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/facturaElectronica", propOrder = {
    "provincia",
    "canton",
    "distrito",
    "barrio",
