...
import com.ndl.erp.fe.v43.*;
import com.ndl.erp.fe.v43.FacturaElectronica.DetalleServicio;
import com.ndl.erp.fe.v43.FacturaElectronica.DetalleServicio.LineaDetalle;
import com.ndl.erp.fe.v43.FacturaElectronica.ResumenFactura;
...
public class InvoiceV43Mapper extends InvoiceBaseMapper implements ComprobanteElectronicoMapper<Invoice, FacturaElectronica> {
    ...
    public InvoiceV43Mapper(List<GeneralParameter> emisor, GeneralParameter iv ) {
    ...
    private void agregarOtroContenido(FacturaElectronica fe) {
...
//        resumenFactura.setTotalVentaNeta(totalBD);
    ...
    protected void createDetalle(Set<InvoiceDetail>  detalles, DetalleServicio detalleServicio,
        ...
        if (detalles != null) {
            ...
            this.totalServDescuentos = 0d;
            this.totalMercDescuentos = 0d;
            Integer linea = 0;
     ...
     * @param detail
     */
    protected Double createLineaDetalle(Integer linea, LineaDetalle ld,
                                        InvoiceDetail detail,  Client c, XMLGregorianCalendar date) {
...
//        Double totalColones = (ld.getPrecioUnitario().doubleValue() * detail.getQuantity()) + ld.getImpuestoNeto().doubleValue();
    ...
    private void addDescuentos(LineaDetalle ld, InvoiceDetail detail) {
        if (detail.getDiscountAmount()==null || detail.getDiscountAmount()==0) {
            return;
        }
        DescuentoType dt = new DescuentoType();
...
//            r.setIdentificacionExtranjero(client.getEnterpriceId());
        ...
        ReceptorType r = new ReceptorType();
//        if (i.getEsClienteInternacional()!=null && i.getEsClienteInternacional().intValue()==1) {
//            r.setNombre(client.getName());
//            r.setIdentificacionExtranjero(client.getEnterpriceId());
//        } else {
            r.setNombre(client.getName());
