...
public class CategoryDTO {
    ...
    public CategoryDTO(String categoria1, String descripcion1) {
        this.categoria1 =  categoria1;
        this.descripcion1 = descripcion1;
        if (descripcion1.startsWith("Servicios")) {
            this.type = "Servicio";
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        return categoria1.equals(that.categoria1) &&
                descripcion1.equals(that.descripcion1);
    }

    @Override
    public int hashCode() {
        return Objects.hash(categoria1, descripcion1);
    }
}
