...
public class InvoiceTiqueteMapper extends InvoiceBaseMapper implements ComprobanteElectronicoMapper<Invoice, TiqueteElectronico> {
    ...
    public InvoiceTiqueteMapper(List<GeneralParameter> emisor, GeneralParameter iv ) {
    ...
    @Override
    public TiqueteElectronico mapFacturaElectronica(Invoice iv) throws DatatypeConfigurationException {

        TiqueteElectronico fe = new TiqueteElectronico();
        //Codigo del tiepo de documento.
        fe.setTipoDocumento(TIPO_DOCUMENTO_TIQUETE_ELECTRONIC0);
...
//        fe.setNsetNormativa(this.createNormativa());
//        fe.setEmpresaId(this.getEmisorData().getEmpresaId());
     ...
     * @return
     */
    protected com.ndl.erp.fe.v43.te.EmisorType getEmisor() {
        com.ndl.erp.fe.v43.te.EmisorType e = new com.ndl.erp.fe.v43.te.EmisorType();

        e.setNombre(this.getEmisorData().getNombre());

        com.ndl.erp.fe.v43.te.IdentificacionType idType = new com.ndl.erp.fe.v43.te.IdentificacionType();
        ...
        com.ndl.erp.fe.v43.te.UbicacionType u = new com.ndl.erp.fe.v43.te.UbicacionType();
        ...
        com.ndl.erp.fe.v43.te.TelefonoType t = new com.ndl.erp.fe.v43.te.TelefonoType();
    ...
    private TiqueteElectronico.ResumenFactura getResumen(Invoice invoice) {
        TiqueteElectronico.ResumenFactura resumenFactura = new TiqueteElectronico.ResumenFactura();

        resumenFactura.setCodigoTipoMoneda(this.getCodigoTipoMoneda(invoice.getCurrency(),null));
//        resumenFactura.setCodigoMoneda(this.getMoneda(invoice.getCurrency()));
     ...
     * @return
     */
    protected TiqueteElectronico.DetalleServicio createDetalleServicio(Set<InvoiceDetail> details) {
        TiqueteElectronico.DetalleServicio detalleServicio = new TiqueteElectronico.DetalleServicio();
     ...
     */
    protected void createDetalle(Set<InvoiceDetail>  detalles, TiqueteElectronico.DetalleServicio detalleServicio) {
        if (detalles != null) {
            ...
            for( InvoiceDetail detail: detalles) {
                TiqueteElectronico.DetalleServicio.LineaDetalle ld = new TiqueteElectronico.DetalleServicio.LineaDetalle();
    ...
    protected Double createLineaDetalle(Integer linea, TiqueteElectronico.DetalleServicio.LineaDetalle ld, InvoiceDetail detail) {
...
//        ld.setDetalle(detail.getDescription());
     ...
     * @return
     */
    protected Double createLineaDetalleFromServices(Integer linea, TiqueteElectronico.DetalleServicio.LineaDetalle ld, InvoiceDetail detail) {
        ld.setNumeroLinea(BigInteger.valueOf((long)linea.intValue()));
...
//    protected TiqueteElectronico.Normativa createNormativa() {
//        TiqueteElectronico.Normativa fn = new TiqueteElectronico.Normativa();
